...
const { getAllData, updateUser, deleteUser, updateSettings, getUserDetails, getDashboardData, getPlatformSettings, updatePlatformToggle, updateSubscriptionPlan } = require('../controllers/adminController');
