...
function AboutNavbar() {
  ...
  return (
    <nav className="w-full bg-white px-8 sm:px-16 py-[22px] flex items-center justify-between relative z-50 shadow-[inset_0px_-1px_1px_0px_rgba(0,0,0,0.1)]">
      <Link href="/" className="shrink-0 h-[34px] w-[134px]">
        <img
      ...
      <div className="hidden md:flex items-center gap-[25px]">
        {navLinks.map((link) => (
          <Link
            key={link.label}
            href={link.href}
            className={`text-base font-medium tracking-[0.32px] transition-colors hover:text-[#f95c4b] ${
              link.active ? "text-[#f95c4b]" : "text-[#424242]"
            }`}
      ...
      <div className="flex items-center gap-5">
        <div className="hidden sm:flex items-center gap-[7px]">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#616161" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
            <line x1="2" y1="12" x2="22" y2="12" />
            <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
          </svg>
          <span className="text-[#616161] text-base font-bold tracking-[0.2px] uppercase" style={{ fontFamily: "'Inter', sans-serif" }}>
            EN
          </span>
        </div>
